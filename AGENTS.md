...
**Contrato de trabajo entre Mauricio (Inversiones Olympo) y Codex. Se lee y se aplica en cada sesión, completo, antes de escribir la primera línea de código.**
...
2. **Columnas `timestamptz`**, UTC en la base, Tegucigalpa en la aplicación.
